        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-click="dropdown" data-close-others="true">
                    <i class="icon-bell"></i>
                    ...
                    @foreach($notifications as $notification)
                        <li class="external" data-href="{{ url($fiscal_id.'/notification/'.$notification->id.'/visit') }}">
                            <h3><span class="bold">
                            

                            @if($notification->notificationable_type=='bill')
                                <a href="{{url($fiscal_id.'/bills/')}}">Bill {{$notification->action}} </a>
                                <i class="fa fa-right"></i>

                            @endif
                             @if($notification->notificationable_type=='invoice')
                                <a href="{{url($fiscal_id.'/invoices/')}}">Invoice {{$notification->action}} </a>
                                <i class="fa fa-right"></i>
                            @endif
                            </span> </h3>
